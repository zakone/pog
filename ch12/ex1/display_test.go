...
func testMapDisplay(t *testing.T) {
	...
	// Output:
	// Display testMapStruct (map[main.S]string):
	// testMapStruct[main.S value] = "first struct"
	// testMapStruct[main.S value].main.S.Age = 10
	// testMapStruct[main.S value].main.S.Name = "someone"
	// testMapStruct[main.S value] = "second struct"
	...
	// Output:
	// Display testMapArray (map[[3]int]string):
	// testMapArray[[3]int value] = "first array"
	// testMapArray[[3]int value].[3]int[0] = 0
	// testMapArray[[3]int value].[3]int[1] = 1
	// testMapArray[[3]int value].[3]int[2] = 2
	// testMapArray[[3]int value] = "second array"
	// testMapArray[[3]int value].[3]int[0] = 3
	// testMapArray[[3]int value].[3]int[1] = 4
	// testMapArray[[3]int value].[3]int[2] = 5
}
